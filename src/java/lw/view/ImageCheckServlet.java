...
public class ImageCheckServlet extends HttpServlet {
    ...
    BufferedImage image =
        ...
        g.setFont(new Font("Arial", Font.PLAIN, 18));//設定字體，寬度可能不夠
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       //亂數產生len個英數字的字串
        if (rand == null) {
         ...
         //2. Use check codes to generate images. (rand write into image)
         BufferedImage image = generateImage(rand, width, height);
         
        
            //3. Out put images with jpeg to response
